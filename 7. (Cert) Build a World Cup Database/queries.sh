...
echo "$($PSQL "SELECT name FROM games RIGHT JOIN teams ON games.winner_id=teams.team_id AND games.opponent_id=teams.team_id WHERE name LIKE 'Co%' ORDER BY name")"
