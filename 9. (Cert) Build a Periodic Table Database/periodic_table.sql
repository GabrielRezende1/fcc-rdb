...
--
-- Name: elements name_unique_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements symbol_unique_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT symbol_unique_key UNIQUE (symbol);
